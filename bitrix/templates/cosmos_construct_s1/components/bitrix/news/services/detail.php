...
<?$ElementID = $APPLICATION->IncludeComponent(
	...
	Array(
		...
		"MSG_ASK_QUESTION" => $arParams["MSG_ASK_QUESTION"],
		"MSG_ASK_QUESTION_UNDER" => $arParams["MSG_ASK_QUESTION_UNDER"],
		"MSG_ZAKAZ" => $arParams["MSG_ZAKAZ"],
		"MSG_ZAKAZ_TITLE" => $arParams["MSG_ZAKAZ_TITLE"],
		"MSG_ZAKAZ_UNDER" => $arParams["MSG_ZAKAZ_UNDER"],
	),
	$component
);?>
